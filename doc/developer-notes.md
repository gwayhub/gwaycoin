...
Gwaycoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 2600.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 2601 for connections and services them.
...
However, in open source software such as Gwaycoin Core, where everyone uses
...
pay attention to for reviewers of Gwaycoin Core code.

General Gwaycoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gwaycoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
