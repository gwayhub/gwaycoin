...
Only requiring some minor changes is gwaycoin.cpp.
...
Changes to gwaycoin.cpp
----------------------
gwaycoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
