...
This mechanism has been integrated into Bitcore-Node-Gwaycoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gwayhub/insight-api-gwaycoin#web-socket-api](https://github.com/gwayhub/insight-api-gwaycoin#web-socket-api)
* API: [https://github.com/gwayhub/insight-api-gwaycoin#instantsend-transactions](https://github.com/gwayhub/insight-api-gwaycoin#instantsend-transactions)
...
By default, the Gwaycoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gwaycoin Core daemon:
