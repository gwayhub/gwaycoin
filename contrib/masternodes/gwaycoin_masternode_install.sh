...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-gwaycoin"
  cd $CONFIGHOME
  git clone https://github.com/gwayhub/sentinel.git $SENTINEL_PATH
  cd $SENTINEL_PATH
...
function important_information() {
  ...
  echo -e "${GREEN}================================================================================================================================${NC}"
  echo -e "Send exactly 1000000 coins to an own address using your cold wallet."
