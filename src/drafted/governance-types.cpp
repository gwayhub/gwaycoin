...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GwaycoinNetwork") type = GwaycoinNetwork;
    if(strType == "GwaycoinNetworkVariable") type = GwaycoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GwaycoinNetwork) s = "GwaycoinNetwork";
    if(type == GwaycoinNetworkVariable) s = "GwaycoinNetworkVariable";
