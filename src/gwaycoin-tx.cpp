...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Gwaycoin Core gwaycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gwaycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gwaycoin transaction") + "\n" +
              "  gwaycoin-tx [options] -create [commands]   " + _("Create hex-encoded gwaycoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gwaycoin transaction
