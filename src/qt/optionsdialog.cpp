    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Gwaycoin-light"), QVariant("light"));
    // ui->theme->addItem(QString("Gwaycoin-light-hires"), QVariant("light-hires"));
    // ui->theme->addItem(QString("Gwaycoin-blue"), QVariant("drkblue"));
    // ui->theme->addItem(QString("Gwaycoin-Crownium"), QVariant("crownium"));
    // ui->theme->addItem(QString("Gwaycoin-traditional"), QVariant("trad"));
