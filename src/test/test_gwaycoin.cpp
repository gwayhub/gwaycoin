...
#define BOOST_TEST_MODULE Gwaycoin Test Suite

#include "test_gwaycoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_gwaycoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
